...
import DataReminderBanner from '../notifications/DataReminderBanner';
import CreditCardReminderBanner from '../credit-cards/CreditCardReminderBanner';
import BillingCycleReminderBanner from '../credit-cards/BillingCycleReminderBanner';
import AutoGeneratedCycleBanner from '../credit-cards/AutoGeneratedCycleBanner';
import LoanPaymentReminderBanner from '../loans/LoanPaymentReminderBanner';
import InsuranceClaimReminderBanner from '../notifications/InsuranceClaimReminderBanner';
import BudgetAlertManager from './BudgetAlertManager';
import NotificationsSection from '../notifications/NotificationsSection';
import AnomalyAlertItem from '../notifications/AnomalyAlertItem';
import AutoLogPrompt from '../loans/AutoLogPrompt';
import { formatCAD as formatCurrency } from '../../utils/formatters';
import { getAnomalies, dismissAnomaly, markAnomalyAsExpected } from '../../services/analyticsApi';
...
const SummaryPanel = ({ selectedYear, selectedMonth, refreshTrigger }) => {
  ...
  const calculateNotificationCount = () => {
    ...
    // Anomaly alerts - each anomaly counts as one notification
