          ...
          <div className="settings-section">
            ...
            <div className="changelog">
              <div className="changelog-entry">
                <div className="changelog-version">v5.17.5</div>
                <div className="changelog-date">February 23, 2026</div>
                <ul className="changelog-items">
                  <li>Billing cycle balance display fixes</li>
                </ul>
              </div>
              <div className="changelog-entry">
                <div className="changelog-version">v5.17.4</div>
                <div className="changelog-date">February 23, 2026</div>
                <ul className="changelog-items">
                  <li>Financial Overview update and styling changes</li>
                </ul>
              </div>
              <div className="changelog-entry">
              ...
              <div className="changelog-entry">
                ...
                <div className="changelog-date">February 21, 2026</div>
                <ul className="changelog-items">
                  <li>Fix SSE session count leak from stale connections</li>
                </ul>
              </div>
              <div className="changelog-entry">
                <div className="changelog-version">v5.17.1</div>
                <div className="changelog-date">February 21, 2026</div>
                <ul className="changelog-items">
                  <li>Fix SSE expense refresh and billing cycle dismiss persistence</li>
                </ul>
              </div>
              <div className="changelog-entry">
                <div className="changelog-version">v5.17.0</div>
                <div className="changelog-date">February 21, 2026</div>
                <ul className="changelog-items">
                  <li>Config endpoint cleanup, billing cycle simplification, billing cycle API optimization</li>
                </ul>
              </div>
              <div className="changelog-entry">
                <div className="changelog-version">v5.16.3</div>
                <div className="changelog-date">February 20, 2026</div>
                <ul className="changelog-items">
                  <li>Fix flaky insurance checkbox test, deploy script cleanup, documentation audit</li>
                </ul>
              </div>
              <div className="changelog-entry">
              ...
              <div className="changelog-entry">
                ...
                <div className="changelog-date">February 20, 2026</div>
                <ul className="changelog-items">
                  <li>Fix UTC timezone mismatch in billing cycle reminders</li>
                </ul>
              </div>
              <div className="changelog-entry">
              ...
              <div className="changelog-entry">
                ...
                <ul className="changelog-items">
                  <li>Fix SSE sync not refreshing SummaryPanel and budget alerts on remote sessions; fix useTabState PBT test isolation</li>
                </ul>
              </div>
              <div className="changelog-entry">
                <div className="changelog-version">v5.15.2</div>
                <div className="changelog-date">February 19, 2026</div>
                <ul className="changelog-items">
                  <li>Fix SSE sync not refreshing SummaryPanel and budget alerts on remote sessions</li>
                </ul>
              </div>
              <div className="changelog-entry">
              ...
              <div className="changelog-entry">
                ...
                <div className="changelog-date">February 19, 2026</div>
                <ul className="changelog-items">
                  <li>Real-time data sync, CI guardrail fix, remove unused Windows bat scripts</li>
                </ul>
              </div>
              <div className="changelog-entry">
                <div className="changelog-version">v5.14.0</div>
                <div className="changelog-date">February 18, 2026</div>
                <ul className="changelog-items">
                  <li>Budget and Financial Overview modal consolidation</li>
                </ul>
              </div>
              <div className="changelog-entry">
                <div className="changelog-version">v5.13.3</div>
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.13.2</div>
                <div className="changelog-date">February 17, 2026</div>
                <ul className="changelog-items">
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.13.1</div>
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.13.0</div>
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.12.1</div>
                <div className="changelog-date">February 15, 2026</div>
                <ul className="changelog-items">
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.12.0</div>
                <div className="changelog-date">February 15, 2026</div>
                <ul className="changelog-items">
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.11.3</div>
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.11.2</div>
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.11.1</div>
                <div className="changelog-date">February 13, 2026</div>
                <ul className="changelog-items">
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.11.0</div>
              ...
              <div className="changelog-entry">
                <div className="changelog-version">v5.10.1</div>
              ...
              <div className="changelog-entry">
                ...
                <div className="changelog-date">February 7, 2026</div>
                <ul className="changelog-items">
                  <li>Refactored expense service into 6 focused sub-services for better maintainability</li>
                  <li>Grouped donations by place in tax deductible view with totals</li>
                  <li>Build script now auto-deploys containers after push</li>
                </ul>
              </div>
              <div className="changelog-entry">
              ...
              <div className="changelog-entry">
                ...
                <ul className="changelog-items">
                  <li>Insurance claim reminders - alerts for pending claims over 30 days</li>
                  <li>Unified Notifications section - consolidated reminder banners</li>
                  <li>Notification count badge showing total active alerts</li>
                  <li>Improved notification organization in Summary Panel</li>
                </ul>
              </div>
              <div className="changelog-entry">
