...
describe('CreditCardDetailView - Billing Cycle Integration', () => {
  ...
  beforeEach(() => {
    ...
    creditCardApi.getUnifiedBillingCycles.mockResolvedValue({ billingCycles: [], autoGeneratedCount: 0, totalCount: 0 });
  });
  ...
  describe('Section Visibility Based on billing_cycle_day', () => {
    it('should show billing cycles tab when billing_cycle_day is configured', async () => {
      ...
      creditCardApi.getUnifiedBillingCycles.mockResolvedValue({ 
        billingCycles: mockBillingCycleHistory.billingCycles.map(c => ({
          ...c,
    ...
    it('should show "Enter Statement" button when billing_cycle_day is configured', async () => {
      // Mock unified billing cycles with an auto-generated cycle that needs statement entry
      creditCardApi.getUnifiedBillingCycles.mockResolvedValue({ 
        billingCycles: [{
          id: 1,
          cycle_start_date: '2026-01-26',
