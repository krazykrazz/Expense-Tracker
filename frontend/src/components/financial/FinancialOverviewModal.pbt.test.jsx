...
vi.mock('../loans/LoanDetailView', () => ({ default: () => null }));
vi.mock('../loans/TotalDebtView', () => ({ default: () => null }));
vi.mock('../loans/InvestmentDetailView', () => ({ default: () => null }));
vi.mock('../credit-cards/PaymentMethodForm', () => ({ default: () => null }));
vi.mock('../credit-cards/CreditCardDetailView', () => ({ default: () => null }));
vi.mock('../credit-cards/CreditCardPaymentForm', () => ({ default: () => null }));
vi.mock('../loans/LoanPaymentForm', () => ({ default: () => null }));
