/**
 * Property-Based Tests: Rollback Workflow Correctness
 *
 * **Property 3: Rollback Workflow Correctness**
 * **Validates: Requirements 6.1, 6.2, 6.3, 6.4, 6.5**
 *
 * For any failed deployment, the rollback workflow should store the previous SHA
 * before deployment, redeploy the previous image on health check failure, perform
 * health checks on the rolled-back deployment, and mark rollback as successful
 * only when health checks pass.
 */
