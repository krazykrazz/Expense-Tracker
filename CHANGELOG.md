...
### Changed
- Extracted filter and view mode state from App.jsx into dedicated FilterContext
- Reduced App.jsx complexity by removing filter-related useState hooks and handlers
- Added comprehensive unit, property-based, and integration tests for FilterContext
