...
const CSS_FILES = [
  { file: 'CollapsibleSection.css', dir: '.' },
  { file: 'BudgetReminderBanner.css', dir: '../financial' },
  { file: 'LoanPaymentReminderBanner.css', dir: '../loans' },
  { file: 'PeopleManagementModal.css', dir: '../tax' },
  { file: 'FinancialOverviewModal.css', dir: '../financial' }
];
  ...
  it('Property 5: No rem units in migrated component CSS', () => {
    ...
    fc.assert(
      fc.property(
        fileIndexArb,
        (index) => {
          const { file: fileName, dir } = CSS_FILES[index];
