...
- [x] 1. Database Migration
  - [x] 1.1 Add billing_cycle_day column migration
  ...
  - [x] 1.2 Update database schema definitions
  ...
  - [x] 1.3 Write property test for migration idempotence
...
- [x] 3. Backend: StatementBalanceService
  - [x] 3.1 Create StatementBalanceService
  ...
  - [x] 3.2 Write property test for billing cycle date calculation
    - **Property 7: Billing Cycle Date Calculation**
    - **Validates: Requirements 3.3**
  
  - [x] 3.3 Write property test for statement balance expense calculation
    - **Property 6: Statement Balance Expense Calculation**
    - **Validates: Requirements 3.1, 3.2**
  
  - [x] 3.4 Write property test for payment subtraction
    - **Property 8: Payment Subtraction in Statement Balance**
    - **Validates: Requirements 3.5, 4.2, 4.3**
  
  - [x] 3.5 Write property test for floor at zero
    - **Property 9: Statement Balance Floor at Zero**
    - **Validates: Requirements 3.6, 4.4**

- [x] 4. Backend: PaymentMethodService Validation Updates
  - [x] 4.1 Add required field validation for credit cards
...
- [x] 6. Backend: ReminderService Updates
  ...
  - [x] 6.2 Write property test for alert show logic
    - **Property 10: Alert Show Logic**
    - **Validates: Requirements 5.2, 5.4**
  
  - [x] 6.3 Write property test for alert suppression logic
...
- [x] 8. Frontend: PaymentMethodForm Updates
  - [x] 8.1 Add billing_cycle_day field to PaymentMethodForm
  ...
  - [x] 8.2 Write test for PaymentMethodForm billing cycle field
    - Test field rendering for credit cards
    - Test validation behavior
    - Test form submission includes billing_cycle_day
    - _Requirements: 6.1, 6.4, 6.6_

- [x] 9. Frontend: CreditCardDetailView Updates
  - [x] 9.1 Display statement balance in CreditCardDetailView
  ...
  - [x] 9.2 Write test for CreditCardDetailView statement balance display
    - Test statement balance rendering
    - Test paid indicator display
    - Test amount due display
    - _Requirements: 7.1, 7.2, 7.3_

- [x] 10. Frontend: API Integration
  - [x] 10.1 Add statement balance endpoint to config
...
- [x] 11. Frontend: Reminder Display Updates
  - [x] 11.1 Update reminder UI to show required payment amount
  ...
  - [x] 11.2 Write test for reminder display
