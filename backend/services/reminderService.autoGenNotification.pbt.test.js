...
describe('ReminderService Auto-Generated Cycle Notifications - Property Tests', () => {
  ...
  /**
   * Generate a billing cycle record with controlled is_user_entered and actual_statement_balance.
   ...
   * actual_statement_balance values, notifications appear exactly for records
   * where is_user_entered = 0 AND actual_statement_balance = 0, and each
      ...
      fc.asyncProperty(
        ...
        async ({ allRecords }) => {
          ...
          const expectedUnreviewed = allRecords.filter(
            r => r.is_user_entered === 0 && r.actual_statement_balance === 0
          );
