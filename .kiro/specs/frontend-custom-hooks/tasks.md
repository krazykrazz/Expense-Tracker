...
- [ ] 1. Set up hooks directory and implement useExpenseFormValidation
  - [ ] 1.1 Create `frontend/src/hooks/` directory and implement `useExpenseFormValidation.js`
  ...
  - [ ]* 1.2 Write property tests for useExpenseFormValidation
  ...
  - [ ] 1.3 Integrate useExpenseFormValidation into ExpenseForm.jsx
...
- [ ] 2. Implement usePaymentMethods and integrate
  - [ ] 2.1 Create `frontend/src/hooks/usePaymentMethods.js`
  ...
  - [ ]* 2.2 Write property tests for usePaymentMethods
    - **Property 1: Payment method localStorage round-trip**
    - **Validates: Requirements 1.4**
  - [ ] 2.3 Integrate usePaymentMethods into ExpenseForm.jsx
  ...
  - [ ] 2.4 Integrate usePaymentMethods into TaxDeductible.jsx
...
- [ ] 4. Implement useInsuranceStatus and integrate
  - [ ] 4.1 Create `frontend/src/hooks/useInsuranceStatus.js`
...
- [ ] 5. Implement useInvoiceManagement and integrate
  ...
  - [ ]* 5.2 Write property tests for useInvoiceManagement
  ...
  - [ ] 5.3 Integrate useInvoiceManagement into ExpenseList.jsx
  ...
  - [ ] 5.4 Integrate useInvoiceManagement into TaxDeductible.jsx
    - Replace inline invoice modal state and invoice fetch logic with hook
    - _Requirements: 3.8, 7.2_
  - [ ] 5.5 Integrate useInvoiceManagement into ExpenseForm.jsx
...
- [ ] 7. Implement useTaxCalculator and integrate
  - [ ] 7.1 Create `frontend/src/hooks/useTaxCalculator.js`
...
- [ ] 8. Implement useYoYComparison and integrate
  ...
  - [ ]* 8.2 Write property tests for useYoYComparison
    - **Property 12: YoY calculateChange matches utility**
    - **Validates: Requirements 6.2**
  - [ ] 8.3 Integrate useYoYComparison into TaxDeductible.jsx
...
- [ ] 9. Final cleanup and verification
  - [ ] 9.1 Verify all three components have reduced line counts
    ...
    - _Requirements: 7.5_
  - [ ] 9.2 Run full frontend test suite
