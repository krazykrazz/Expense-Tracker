...
describe('BudgetService - Unit Tests', () => {
  ...
  describe('Validation Tests', () => {
    test('should reject tax-deductible categories', async () => {
      ...
      ).rejects.toThrow('Budget can only be set for Clothing, Dining Out, Entertainment, Gas, Gifts, Groceries, Housing, Insurance, Personal Care, Pet Care, Recreation Activities, Subscriptions, Utilities, Automotive, Other categories');
