...
- [x] 1. Database Schema and Migration
  - [x] 1.1 Add mortgage fields to loans table via migration
...
- [x] 2. Backend Repository Layer
  - [x] 2.1 Extend LoanRepository for mortgage fields
  ...
  - [x] 2.2 Write property test for non-mortgage null fields
    - **Property 3: Non-Mortgage Loans Have Null Mortgage Fields**
    - **Validates: Requirements 2.5**

  - [x] 2.3 Write property test for immutable fields on update
...
- [x] 4. Backend Service Layer - Validation
  - [x] 4.1 Create MortgageService with validation methods
  ...
  - [x] 4.3 Write property test for validation bounds
    - **Property 7: Validation Bounds**
    - **Validates: Requirements 10.1, 10.2, 10.3, 10.4, 10.5**

- [x] 5. Backend Service Layer - Calculations
  - [x] 5.1 Implement equity calculation in MortgageService
  ...
  - [x] 5.2 Implement amortization schedule generation
  ...
  - [x] 5.5 Write property test for equity calculation
    - **Property 4: Equity Calculation Formula**
    - **Validates: Requirements 4.1, 4.4**

  - [x] 5.6 Write property test for amortization invariants
    - **Property 5: Amortization Schedule Invariants**
    - **Validates: Requirements 5.2, 5.3**

  - [x] 5.7 Write property test for renewal status
    - **Property 6: Renewal Status Calculation**
    - **Validates: Requirements 7.1, 7.2, 7.3**

- [x] 6. Backend Service Layer - Integration
  - [x] 6.1 Extend LoanService for mortgage operations
  ...
  - [x] 6.2 Write property test for mortgage round-trip
...
- [x] 8. Backend Controller and Routes
  - [x] 8.1 Extend LoanController for mortgage endpoints
  ...
  - [x] 8.3 Update frontend API config
    - Add new endpoints to `frontend/src/config.js` API_ENDPOINTS
    - _Requirements: 5.1, 4.2_

- [x] 9. Frontend - Form Integration
  - [x] 9.1 Extend LoansModal with mortgage form fields
  ...
  - [x] 9.2 Add mortgage API functions
...
- [x] 10. Frontend - Mortgage Detail View
  - [x] 10.1 Create MortgageDetailSection component
  ...
  - [x] 10.2 Create EquityChart component
  ...
  - [x] 10.3 Create AmortizationChart component
  ...
  - [x] 10.4 Extend LoanDetailView for mortgages
...
- [x] 11. Checkpoint - Frontend components complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 12. Integration and Polish
  - [x] 12.1 Wire up mortgage creation flow
  ...
  - [x] 12.2 Wire up mortgage detail view
  ...
  - [x] 12.3 Test variable rate mortgage flow
