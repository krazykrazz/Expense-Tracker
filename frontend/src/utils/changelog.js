...
const changelogEntries = [
  ...
  },
  {
    ...
    added: [],
    changed: [],
    fixed: ['Fix a regression where the health check could close the database connection after startup'],
    removed: [],
  },
  {
    version: '1.10.1',
    ...
    added: [],
    changed: [],
    fixed: ['Fix a database connection leak and verify backup archives are restorable before reporting success'],
    removed: [],
  },
  {
    version: '1.10.0',
  ...
  },
  {
    ...
    date: 'February 28, 2026',
    added: [],
    changed: ['Mortgage balance interest tracking, UI refresh fix'],
    fixed: [],
    removed: [],
  },
  {
