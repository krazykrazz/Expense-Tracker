#!/usr/bin/env node
/**
 * Script to create predictionService.core.pbt.test.js by combining
 * the original pbt and confidence test files
 */

const fs = require('fs');
const path = require('path');

// Read the original files from git history or recreate from the content we have
const coreContent = `/**
...
fs.writeFileSync(path.join(servicesDir, 'predictionService.core.pbt.test.js'), coreContent);

console.log('✓ Created predictionService.core.pbt.test.js');
