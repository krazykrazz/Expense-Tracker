...
1. WHEN viewing expense type breakdowns (Food, Gas, Other, Tax-Medical, Tax-Donation) THEN the Expense Tracker SHALL display a trend indicator next to each type's total
