/**
 * Property-Based Tests for Reminder Service - is_user_entered Alert Suppression
 * Feature: credit-card-billing-fixes
 * Property 1: Auto-generated records are not authoritative for alert suppression
 *
 * For any credit card with a billing cycle record where is_user_entered = 0,
 * the reminder service should NOT use that record's actual_statement_balance
 * for alert suppression. Only records with is_user_entered = 1 should set
 * hasActualBalance = true and influence is_statement_paid.
 *
