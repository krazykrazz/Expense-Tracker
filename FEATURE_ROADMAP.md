...
- **Renamed Labels**: "Payment Amount History" (was "Payment History") to clarify it tracks payment amount changes, not individual payments
- **LoanPaymentHistory Hidden for Mortgages**: Individual payment list hidden since mortgage payments are tracked via the balance engine
